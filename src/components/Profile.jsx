import userImagen from "../assets/img/images.png";
const Profile = () => {
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md mt-8">
      ...
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        <div className="flex flex-col items-center bg-gray-100 rounded-lg p-4 w-full md:w-1/3">
          ...
          <p className="font-semibold">Ciudadano</p>
          <p className="text-gray-500 text-sm mt-2">
            Miembro desde: 2 de noviembre de 2025
          </p>
        </div>
        ...
        <div className="flex-1 bg-gray-100 rounded-lg p-4">
          ...
          <p className="mb-1">
            Nombre: <span className="text-gray-700">No especificado</span>
          </p>
          <p className="mb-1">
            Email: <span className="text-gray-700">josefr1@example.com</span>
          </p>
          <p className="mb-1">
            Teléfono: <span className="text-gray-700">No especificado</span>
          </p>
          <p className="mb-3">
            Dirección: <span className="text-gray-700">No especificada</span>
          </p>
